...
Usage:
Just clicking the exe file in this directory to open the mainwindow, there is a calibration munu in the menu bar, and then activating it the calibration window will show you on the screen if no problems issue. Then you can enjoy it at your disposal. By the way, there are some example images in the pictures subdirectory.

Tested on win10-64bit and ubuntu1604-64bit, however this version is not for any linux system.

Unknown£º
Usually diffrent machine surport diffrent versions of openGL, which may lead to the mainwindow crashed, because this a opengl widgits on the mainwindow. 

If there is anything puzzling around you about this sotfware, please send a email to me.
